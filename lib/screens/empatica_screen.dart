...
class _EmpaticaScreenState extends State<EmpaticaScreen> {
  ...
  Future<void> _verileriYukle() async {
    ...
    try {
      final veriler =
      await EmpaticaService.getBiyoSensorVerileri(widget.hasta.hastaId);
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  widget.hasta.hastalikAdi ?? 'Tanı Yok',
                  style: const TextStyle(
                    fontSize: 13,
          ...
          Column(
            ...
            children: [
              ...
              Text(
                '${_filtrelenmisVeriler.length} ölçüm',
                style: const TextStyle(
                  fontSize: 11,
                  color: Color(0xFF94A3B8),
                ),
    ...
    return GridView.count(
      ...
      children: [
        ...
        _metrikKart(
          ...
          'Sıcaklık',
          '${ort['sicaklik']?.toStringAsFixed(1) ?? '-'}',
          '°C',
          Colors.cyan,
        ...
        _metrikKart(
          ...
          'Uyku',
          _filtrelenmisVeriler.isNotEmpty
              ? (_filtrelenmisVeriler.first.uykuEvresi ?? '-')
              : '-',
          '',
          Colors.blueGrey,
      ...
      child: Column(
        ...
        children: [
          ...
          if (birim.isNotEmpty)
            Text(
              birim,
              style: TextStyle(fontSize: 9, color: renk.withOpacity(0.7)),
            ),
          const SizedBox(height: 4),
          Text(
            etiket,
  ...
  Widget _filtreButonu() {
    return ActionChip(
      ...
      avatar: Icon(
        ...
        size: 14,
        color: _seciliTarih == null ? kPrimary : Colors.white,
      ),
      label: Text(
        _seciliTarih == null
            ? 'Filtrele'
      ...
      backgroundColor:
      _seciliTarih == null ? kPrimary.withOpacity(0.1) : kPrimary,
    );
  }
