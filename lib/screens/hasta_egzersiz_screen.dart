...
class _HastaEgzersizScreenState extends State<HastaEgzersizScreen> {
  ...
  Future<void> _tekrarTamamla(EgzersizAtama atama) async {
    try {
      ...
      final idx =
      _atamalar.indexWhere((a) => a.egzersizAtamaId == atama.egzersizAtamaId);
      if (idx != -1 && mounted) setState(() => _atamalar[idx] = guncel);
      if (mounted && guncel.tamamlandiMi) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('${atama.egzersizAdi} tamamlandı! Harika iş çıkardın 🎉'),
    ...
    child: Row(children: [
      ...
      const Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            SizedBox(height: 2),
            Text('Klinisyeninizin atadığı egzersizleri buradan görebilirsiniz.',
      ...
      return const Center(
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(height: 12),
              Text('Henüz egzersiz atanmadı',
                  style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                      color: Color(0xFF64748B))),
              SizedBox(height: 4),
              Text('Klinisyeniniz size egzersiz atadığında burada görünecek.',
                  textAlign: TextAlign.center,
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (done && toplam > 1) ...[
              ...
              Row(children: [
                ...
                Text('Tüm $toplam tekrar tamamlandı',
                    style: const TextStyle(
...
class _EgzersizDetaySheet extends StatefulWidget {
  ...
  const _EgzersizDetaySheet({required this.atama, this.onTamamla});
...
class _EgzersizDetaySheetState extends State<_EgzersizDetaySheet> {
  ...
  Future<void> _yukle() async {
    ...
    try {
      ...
      if (mounted) setState(() { _video = video; _yukleniyor = false; });
    } catch (e) {
      if (mounted) setState(() { _hata = e.toString(); _yukleniyor = false; });
    }
  }
              ...
              children: [
                ...
                if (_yukleniyor)
                  ...
                  Padding(
                    ...
                    child: Text('Video bilgisi yüklenemedi.',
                        style: const TextStyle(
                    ...
                    Wrap(spacing: 8, runSpacing: 6, children: [
                      ...
                      _InfoChip(
                        ...
                        label: done ? 'Tamamlandı' : '$kalan / $toplam tekrar',
                        color: done ? const Color(0xFF16A34A) : kPrimary,
                      ),
                    ]),
                    const SizedBox(height: 16),
    ...
    child: Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.play_circle_outline,
            size: 48, color: kPrimary.withOpacity(0.5)),
        if (tapable) ...[
          const SizedBox(height: 8),
          Text('Videoyu oynatmak için dokunun',
              style: TextStyle(
                  fontSize: 13, color: kPrimary.withOpacity(0.6))),
        ],
      ]),
    ),
  );
